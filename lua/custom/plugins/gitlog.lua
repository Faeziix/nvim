...
return {
  ...
  keys = {
    ...
    { "<leader>gj", "<cmd>diffget //2<CR>", desc = "Git diffget (accept HEAD)" },
    { "<leader>gk", "<cmd>diffget //3<CR>", desc = "Git diffget (accept new change)" },
    { "<leader>grh", "<cmd>Git reset --hard<CR>", desc = "Git Reset (hard)" },
    { "<leader>g=", "<cmd>Git push --force-with-lease<CR>", desc = "Git Push (force with lease)" },
  },
}
